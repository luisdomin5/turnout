...
RUN ( pip --version ; echo "pip 20.3 xxxx") | sort | head -n 1 | grep -q xxxx && pip install -r requirements.txt --use-deprecated=legacy-resolver || pip install -r requirements.txt
